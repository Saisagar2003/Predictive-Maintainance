...
Model = joblib.load('C:/Users/Saisagar/Downloads/wetransfer_itpml37-final-document-zip_2025-01-30_0612/ITPML37-FINAL CODING/ITPML37-FINAL CODING/Model.pkl')
def model(request):
    if request.method == 'POST':
